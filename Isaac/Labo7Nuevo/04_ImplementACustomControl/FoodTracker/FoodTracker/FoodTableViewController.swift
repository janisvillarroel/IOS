...
class FoodTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let var1 = Meal(name:"Pique",photo:UIImage(named:"pique"),raiting:2)
        let var2 = Meal(name:"Silpancho",photo:UIImage(named:"silpancho"),raiting:4)
        meals.append(var1!)
        meals.append(var2!)
